...
class Post extends \yii\db\ActiveRecord
{
    ...
    {
        //return Comment::find()->where(['post_id'=>$this->id,'status'=>2])->orderBy(['id'=>SORT_DESC])->all();
        //return $this->hasMany(Comment::className(), ['post_id' => 'id'])->where(['status'=>2])->orderBy(['id'=>SORT_DESC]);
        return $this->hasMany(Comment::className(), ['post_id' => 'id'])
